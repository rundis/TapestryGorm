...
import no.rundis.pensions.domain.*
    ...
    def populate() {
        ...
        builder.pensiondata {
            ...
            employee (ssn: "111-222", firstName: "Magnus", lastName: "Rundberget", company: rundisCorp,
                address (street: "Quietcomfort street 1C", zip: "8888", city: "Springfield")) {
                schemeMembership(scheme: scheme1, validFor: DateRange.range("2000-01-01", "2007-01-01")) {
                    planAssignment(plan: scheme1Plan1, validFor: DateRange.range("2001-01-01", "2004-01-01"))
                    planAssignment(plan: scheme1Plan2, validFor: DateRange.range("2004-01-02", "2007-01-01"))
                }
                schemeMembership(scheme: scheme2, validFor: DateRange.openEnded("2007-01-02")) {
                    planAssignment(plan: scheme2Plan1, validFor: DateRange.range("2007-01-02", "2009-01-01"))
                    planAssignment(plan: scheme2Plan2, validFor: DateRange.openEnded("2009-01-02"))
                }
            }
